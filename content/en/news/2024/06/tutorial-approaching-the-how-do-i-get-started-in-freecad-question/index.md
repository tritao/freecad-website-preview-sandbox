...
![Freecad header](freecad_header.webp "Freecad header")
...
![Freecad forum](freecad_forum.webp "Freecad forum")
...
![About FreeCAD version](about_FC_version.webp "About FreeCAD version")
...
{{< youtube id=Odr5viqPwkc title="Basic Beginners FreeCAD v1 / 0.22 | Lesson 2 | Basic Preferences for Course | Mango Jelly" loading=lazy >}}

{{< youtube id=dyU1U6oN0Yk title="FreeCAD: The 2022 Complete Beginners Guide To Part Design | Joko Engineering" loading=lazy >}}
...
![FreeCAD for makers](fc_for_makers.webp "FreeCAD for makers")
