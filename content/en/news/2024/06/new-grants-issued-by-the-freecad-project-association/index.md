...
**Francisco de Assis Rosa** will be designing furniture and parametric components for the [FreeCAD library](https://wiki.freecad.org/Parts_Library_Workbench). Deliverables are "a few dozen pieces of furniture and parametric components (for architectural and engineering projects) for immediate use in FreeCAD". The project cost is USD $5,000.
