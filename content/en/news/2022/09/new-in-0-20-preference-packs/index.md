...
Read the [original announcement and get help with the feature in the FreeCAD forums discussion](https://forum.freecad.org/viewtopic.php?t=62477). Technical information about Preference Packs can be found on the [FreeCAD Preference Packs wiki page](https://wiki.freecad.org/Preference_Packs).