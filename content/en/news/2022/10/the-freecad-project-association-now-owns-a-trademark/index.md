...
tags:
  ...
  - logo
cover:
  image: Screenshot-from-2022-10-07-12-45-06.webp
...
The [logo itself](https://github.com/freecad/freecad/blob/master/src/Gui/Icons/freecad.svg) is still covered by the [LGPL license](https://github.com/freecad/freecad/blob/master/LICENSE), so everyone still has the legal rights to use the logo as far as the LGPL permits. The trademark predominantly acts as an additional tool to enforce the underlying copyright when the LGPL is violated. actually acts more like a super-copyright, which does not contradict the open-source license.
