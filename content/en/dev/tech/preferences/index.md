---
title: Preferences
description: How to handle, retrieve and update user preferences.
weight: 10
---
...
- custom preference dialogs
  - [a sample dialog](https://github.com/freecad/freecad/blob/master/src/Mod/Part/Gui/DlgSettingsGeneral.cpp)
