---
title: VSCode guide
description: Guide for getting started with VSCode.
weight: 4
---
...
```
git clone https://github.com/user/freecad --recurse-submodules
```
...
![VSCode extensions](extensions.webp "VSCode extensions")
